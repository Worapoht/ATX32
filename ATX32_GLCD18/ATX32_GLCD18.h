...
ATX32_GLCD_ST7735 __tft = ATX32_GLCD_ST7735(cs, dc, rst); // Remark Hardware SPI Mode for avoid Timer2 conflict
...
//  __tft.initSBGR();               // initialize a GCLCDIL chip, BGR new 1.8"
  __tft.initR(INITR_BLACKTAB);   // initialize a ST7735S chip, black tab
