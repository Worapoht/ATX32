...
#ifndef _Adafruit_ST7735_STMH_STM_
#define _Adafruit_ST7735_STMH_STM_
...
class Adafruit_ST7735_STM : public Adafruit_GFX_AS {

 public:

  Adafruit_ST7735_STM(int8_t CS, int8_t RS, int8_t SID, int8_t SCLK, int8_t RST = -1);
  Adafruit_ST7735_STM(int8_t CS, int8_t RS, int8_t RST = -1);
